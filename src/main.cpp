...
void TfrmMain::InitializeFormAndControls() /* Control initialization function generated by the designer. Modifications will be lost. */
{
	...
	cbThousandSep->SetBounds(nlib::Rect(166, 13, 217, 37));
	...
	spnDecDigits->SetBounds(nlib::Rect(166, 77, 203, 98));
	...
	UpDownDecDigits->SetBounds(nlib::Rect(202, 77, 219, 98));
	UpDownDecDigits->SetMaxValue(20);
