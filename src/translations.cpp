...
static _LanguageTexts_private __texts[] = {
 ...
 { FCT_CHARFONT,			L"&Font For 'As String...' Display...",				
                            L"&Betű a 'Szöveges megjelenítéshez...á" },
 ...
 { FCT_TIPDEG  ,            L"Degrees",                         L"Fok (°)" },
 { FCT_TIPRAD  ,            L"Radians",                         L"Radián" },
 { FCT_TIPGRAD ,            L"360° = 400 grad",                 L"360° = 400 grad" },
 { FCT_TIPTURN ,            L"360° = 1 turn",                   L"360° = 1 turn" },
 { FCT_TIPDPOV ,            L"Exponent display with 10's power",  L"10 hatványok használata" },
 { FCT_TIPDHTML,            L"Exponent display with <sup>x</sup>",L"Kitevő HTMLkódként <sup>x</sup>" },
 { FCT_TIPDTEX ,            L"Exponent display with {10^x}",      L"Kitevő TEX formátumban: {10^x}" },
 ...
 // error messages
 { FCT_BUILTIN_FUNCTIONS_CANNOT_BE_REDEFINED,	L"Builtin functions cannot be redefined",
                                                L"Beépített függvényeket nem lehet átdefiniálni"},
 { FCT_BUILTIN_VARIABLES_CANNOT_BE_REDEFINED,	L"Builtin variables cannot be redefined",				
                                                L"Beépített változókat nem lehet átdefiniálni"},
 { FCT_CLOSING_QUOTE_NOT_FOUND,					L"Closing quote not found",				
                                                L"Záró idézőjel hiányzik"},
 { FCT_DIVISON_BY_0,					        L"Divison by 0",				
                                                L"0-val osztás"},
 { FCT_EITHER_THE_SEPARATOR_WAS_MISPLACED_OR_PARENTHESIS_WERE_MISMATCHED,					
                                                L"Either the separator was misplaced or parenthesis were mismatched",				
 ...
 { FCT_FUNCTION_DEFINITION_MISSING_RIGHT_BRACE,	L"Function definition missing right brace",				
                                                L"A függvény definíció záró zárójele hiányzik"},
 { FCT_FUNCTION_MISSING_OPENING_BRACE,			L"Function missing opening brace",				
                                                L"A függvény definíció nyitó zárójele hiányzik"},
 { FCT_ILLEGAL_AT_LINE_END,					    L"Illegal at line end",				
                                                L"Sor végén nem megengedett"},
 { FCT_ILLEGAL_BINARY_NUMBER,					L"Illegal binary number",				
                                                L"Nem bináris szám"},
 ...
 { FCT_ABOUTLINE2,      L"(especially useful for physicists and programmers)", 
                        L"(különösen műszakiaknak és programozóknak)"},
 { FCT_ABOUTLINE3,      L"Based on the 'LongNumber' cross platform", 
                        L"Alapja a 'LongNumber', multiplatform"},
 { FCT_ABOUTLINE4,      L"arithmetic library of A. Sólyom", 
                        L"aritmetikai könyvtár © Sólyom. A."},
 { FCT_ABOUTLINE5,      L"and", L"és"},
 { FCT_ABOUTLINE6,      L"the NLIB library © Zoltán. Sólyom", 
                        L"Zoltán Sólyom NLIB © könyvtára"},
 { FCT_ABOUTLINE7,      L"This program (except NLIB) is open source (GPL3)", 
                        L"Ez a program az NLIB-et kivéve  Copyright (GPL3)"},
};
...
wchar_t* LanguageTexts::GetTranslationFor(TextIDs id) const
{
	...
	if (__texts[(int)id].id != id)
    {
        ...
        {
            if (__texts[i].id == id)
                return __texts[i].texts[(int)_lang];
        }
        return L"";
    }
    else
        return __texts[(int)id].texts[(int)_lang];
}
