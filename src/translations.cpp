...
// { FCT_HISTORY,				L"H&istory",						L"E&lőzmények" },
 ...
 { FCT_TIPDEG  ,            L"Degrees",
                            L"Fok (°)" },
 { FCT_TIPDHTML,            L"'a^x' displayed as a<sup>x</sup>",
                            L"'a^x' megjelenítés: a<sup>x</sup>" },
 { FCT_TIPDP   ,            L"Double precision floating point format",
                            L" Dupla pontos lebegőpontos számformátum" },
 { FCT_TIPDPOV ,            L"'a^x' as 10's power",  
                            L"'a^x' felső indexben" },
 { FCT_TIPDTEX ,            L"'a^x' displayed as a 10^{x}",
                            L"'a^x' TEX formátumban: 10^{x}" },
